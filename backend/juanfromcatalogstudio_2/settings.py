"""
Django settings for juanfromcatalogstudio_2 project.
...
ROOT_URLCONF = 'juanfromcatalogstudio_2.urls'
...
WSGI_APPLICATION = 'juanfromcatalogstudio_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "juanfromcatalogstudio_2 API",
    "DESCRIPTION": "API documentation for juanfromcatalogstudio_2 App",
    "VERSION": "v1",
}

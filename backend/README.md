...
## Project Structure
    ...
    ├── juanfromcatalogstudio_2  # Django project configurations
...
1. Clone this repo and `cd juanfromcatalogstudio_2`
...
2. Clone this repo and `cd juanfromcatalogstudio_2`
